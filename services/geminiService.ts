...
After the closing argument, include an unlabeled closing section of exactly three questions. These are not summaries of what the piece already said. Question one must name a specific institution or person and ask something the evidence in the piece raises but cannot answer. Question two must challenge the reader to reconsider something they believed about power, law, or justice before reading the piece. Question three must be the most uncomfortable of the three: it must name the specific unresolved crime, the specific missing evidence, or the specific unanswered accountability gap, and force the reader to sit with an answer they do not want to admit. None of the three questions may summarize or repeat content already stated in the piece. All three must be forward-looking and genuinely debatable with no obvious correct answer.
...
TITLE AND SUBTITLE VERIFICATION: Confirm the title is ALL CAPS subject name, colon, and a consequence of maximum twelve words, with no dashes, no symbols, and no question marks. Confirm the subtitle is exactly one sentence stating the suppressed truth or institutional betrayal, does not end with a question mark, does not contain a call to action, and does not tell the reader what they will find inside the piece.

PROHIBITED ELEMENTS FINAL SCAN: Confirm the complete absence of dashes used as punctuation anywhere in prose, semicolons anywhere in prose, bold text, italic text, bullet points, numbered lists, any subheading other than the five official section headers, passive voice constructions where active voice is possible, vague abstractions without an immediate specific fact to prove them, a year-based opening such as the current year is or in ${currentYear}, and template phrases such as this is the forensic audit of.
